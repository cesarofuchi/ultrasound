...
function EAM = ExtAutoCorrelation(usdObj,c,NpRange)
...
% Np is the number of 2*pi rotations to look for dealising purposes. 
% standard is Np=[-2 -1 0 1 2];
